...
namespace NeoxTable\NeoxTableBundle\DependencyInjection;
...
final class Configuration implements ConfigurationInterface
{
    ...
    {
        $treeBuilder = new TreeBuilder('neox_table');
        ...
        $rootNode
            ->children()
                ->scalarNode('path_js_bs-datatable')
                    ->defaultValue("build/canvas/jiiis/components/bs-datatable.js")
